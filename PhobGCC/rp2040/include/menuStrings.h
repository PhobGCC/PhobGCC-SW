...
const char timescope9[]      = "Pos %:";
const char timescope10[]     = "Neg %:";
const char timescope11[]     = "Dash-";
const char timescope12[]     = "back %:";
const char timescope13[]     = "Empty";
const char timescope14[]     = "Pivot %";
const char timescope15[]     = "No Turn %:";
const char timescope16[]     = "Length %:";
const char timescope17[]     = "No PS%:";
const char timescope18[]     = "ADT PS %:";
const char timescope19[]     = "PS %:";
